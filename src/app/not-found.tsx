  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-black">
      ...
      >
        ...
        >
          <span className="relative z-10 flex items-center gap-2">Voltar para o Início</span>
        ...
        <div className="animation-delay-200 absolute left-1/2 top-1/2 -z-10 h-64 w-64 -translate-x-1/2 -translate-y-1/2 animate-pulse rounded-full bg-orange-500/5" />
      </motion.div>
    </div>
  )
}
