...
import { Box, Button, Center, Flex, FormControl, FormLabel, Input, Stack, Text, Icon } from '@chakra-ui/react';
...
const LoginPage = () => {
  ...
  return (
    <Flex minH="100vh" bg="gray.900">
      ...
      >
        <Center mb={8}>
          {/* Add your logo or any graphic here */}
          <Icon as={FaUserCircle} w={24} h={24} color="red.600" />
        </Center>
