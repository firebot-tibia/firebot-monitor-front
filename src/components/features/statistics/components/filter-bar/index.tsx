...
const FilterBar: React.FC<FilterBarProps> = ({
  ...
  const handleSearch = () => {
    const characterExists = [allyGainData, allyLossData, enemyGainData, enemyLossData].some(data =>
      data.data.some(player => player.name.toLowerCase() === searchInput.toLowerCase()),
    )
