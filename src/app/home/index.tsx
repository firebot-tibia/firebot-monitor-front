...
import { Box, Card, CardBody, CardHeader, Container, Heading, Input, useToast } from '@chakra-ui/react';
    ...
    <Container maxW="6xl" h="100vh" display="flex" flexDirection="column" gap="4">
      <Card bg="rgba(255, 255, 255, 0.2)" backdropFilter="blur(10px)">
        ...
        <CardBody>
          ...
          {guildMembers && (
            <>
              <Heading as='h2' size='lg' mt="4">Elite Knights</Heading>
              <TableWidget 
                columns={columns}
                data={guildMembers.members.Knight}
                isLoading={isLoading}
              />
              <Heading as='h2' size='lg' mt="4">Master Sorcerers</Heading>
              <TableWidget 
                columns={columns}
                data={guildMembers.members.Sorcerer}
                isLoading={isLoading}
              />
              <Heading as='h2' size='lg' mt="4">Royal Paladins</Heading>
              <TableWidget 
                columns={columns}
                data={guildMembers.members.Paladin}
                isLoading={isLoading}
              />
              <Heading as='h2' size='lg' mt="4">Elder Druids</Heading>
              <TableWidget 
                columns={columns}
