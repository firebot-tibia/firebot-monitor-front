...
export const CharacterTypesManager: React.FC<CharacterTypesManagerProps> = ({ addType }) => {
  ...
  return (
    <>
      <Button onClick={onOpen} size="sm" colorScheme="gray" variant="ghost" leftIcon={<AddIcon />}>
        Adicionar Tipo
      </Button>

      <Modal isOpen={isOpen} onClose={onClose}>
        <ModalOverlay bg="blackAlpha.300" backdropFilter="blur(10px)" />
        <ModalContent bg="red.800" color="white" borderRadius="md" boxShadow="xl">
          ...
          <ModalFooter borderTopWidth="1px" borderColor="gray.700">
            <Button onClick={handleAddType} colorScheme="red" mr={3} leftIcon={<AddIcon />}>
              Adicionar
            </Button>
