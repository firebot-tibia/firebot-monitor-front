      ...
      >
        ...
        <DrawerBody>
          <VStack spacing={4} align="stretch">
            ...
            <Card bg={cardBgColor} borderColor={borderColor} borderWidth={1}>
              <CardBody>
                <Text mb={3} fontWeight="medium" fontSize="sm">
                ...
                <VStack spacing={4} align="stretch">
                  ...
                  <Flex justify="space-between" align="center">
                    <HStack>
                      <Clock size={14} />
                      <Text fontSize="sm">Janela de tempo:</Text>
                    </HStack>
                    ...
                    <HStack>
                      <NumberInput
                        size="sm"
                        value={timeThreshold}
                        onChange={(_, value) => handleTimeThresholdChange(value)}
                        min={1}
                        max={30}
                        w="70px"
                      >
                  ...
                  {/* Member Threshold Setting */}
                  <Flex justify="space-between" align="center">
                    <HStack>
                      <Bell size={14} />
                      <Text fontSize="sm">Limite de personagens:</Text>
                    </HStack>
                    ...
                    <HStack>
                      <NumberInput
                        ...
                        onChange={(_, value) => handleMemberThresholdChange(value)}
                        min={1}
                        max={20}
                        w="70px"
                      >
                      ...
                      <Text fontSize="sm">personagens</Text>
                    </HStack>
                  </Flex>

                  {/* Current Count */}
                  <Box
                    bg={activeCharacterCount >= memberThreshold ? 'red.900' : 'transparent'}
                    p={2}
                    borderRadius="md"
                    transition="all 0.3s"
                  >
                    <Text fontSize="sm" textAlign="center">
                      {activeCharacterCount} personagen{activeCharacterCount !== 1 ? 's' : ''} detectado{activeCharacterCount !== 1 ? 's' : ''} nos últimos {timeThreshold} minutos
                    </Text>
                  </Box>
                </VStack>
              </CardBody>
